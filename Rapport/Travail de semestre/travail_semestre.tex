...
\documentclass[a4paper,11pt,leqno,openbib,table]{memoir} %add 'draft' to turn draft option on (see below)
%
%
% Adding metadata:
\usepackage{datetime}
...
\pagestyle{fancy}
\fancyhf{}
\lhead{\includegraphics[height=1cm]{logos/hepia}}
\chead[\leftmark]{Travail de semestre}
\rhead{\includegraphics[height=1cm]{logos/hes-so}}
\cfoot{Page \thepage}
\lfoot{Quentin Zeller}
\rfoot{\today}
...
%\renewcommand{\lstlistingname}{Table des codes} --> non functional
\lstlistoflistings
...
\clearemptydoublepage
\import{chapters/OpenCV/}{chap03.tex}
\clearemptydoublepage
\import{chapters/HBBTV/}{chap02.tex}
\clearemptydoublepage
\import{chapters/Wowza/}{chap04.tex}
\clearemptydoublepage
\import{chapters/Autres/}{chap05.tex}
\clearemptydoublepage
\import{chapters/Conclusion/}{chap06.tex}
\clearemptydoublepage
