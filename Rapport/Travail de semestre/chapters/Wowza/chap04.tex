...
Le test du serveur Wowza a été fait avec la version développer de Wowza, donc la licence est disponible pendant 6 mois.
\begin{itemize}
...
\begin{itemize}
	...
	\item A des fins de debugging il peut être intéressant de lancer le fichier "startup.bat" se trouvant dans le dossier "/bin/" de Wowza. Celui-ci nous permet de voir la sortie standard de l'application et les éventuelles erreurs d'exécution.
\end{itemize}
