...
Clamp est un module transcoder de Wowza du même type que celui montré plus haut. Il est développé par Streamtoolbox.com qui est une compagnie développant des outils de retouche vidéo à la volée et de statistiques pour Wowza. Toute leurs solutions son payantes. La solution qui nous intéresse, Clamp, a un prix unique de 300\$ par serveur.\cite{streamtoolbox}
Nous profitons de la présentation de ce module pour expliquer comment celui-ci est installé sur le serveur, l'installation n'est pas très pratique ni même claire, 
