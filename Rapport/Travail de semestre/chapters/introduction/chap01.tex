...
\begin{table}
	\caption{Liste et commentaires sur les différents outils multimédias.
...
\begin{longtabu} to \textwidth {l >{\bfseries}X[r, 1] X[4] l}
	...
	& GStreamer QT Overlay & Est un module basé sur Gstreamer qui permet d'ajouter des overlays en temps réel en amont du logiciel Gstreamer. Attention, certain navigateur web interdisent le site. \cite{gstream-ridgerun} Possède un très petite communauté. \newline Prix 2500\$ & ? \\
	& Microsoft & Selon des représentants de Microsoft, ils pourraient a terme proposer API d'édition de flux vidéo dans un futur proche. A l'heure rien n'existe si ce n'est du transcodage (DirectX - DirectShow) & - \\
