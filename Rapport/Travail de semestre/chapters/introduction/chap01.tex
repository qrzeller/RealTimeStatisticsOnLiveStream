...
\begin{tabu} to \textwidth {l >{\bfseries}X[r, 1] X[4] l}
	...
	& ffmpeg & Programme de transcodage, très limité dans l'intégration de contenu. & Facile \\
	
\end{tabu}
\paragraph{OpenCV} : Voir chapitre \ref{chap:OpenCV}
\paragraph{Wowza}
 Streaming Engine est un serveur multimédia permettant la diffusion de contenu vidéo en streaming. Son secteur ded marché est principalement la vidéo à la demande ainsi que la vidéo en temps réel.
